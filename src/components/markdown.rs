...
pub fn MarkdownRenderer(
    ...
    view! {
        <div
            class=format!("markdown-content {}", class)
    ...
    for event in parser {
        match event {
            Event::Start(Tag::CodeBlock(CodeBlockKind::Fenced(lang))) => {
                ...
                write!(
                    ...
                    r#"<div class="relative my-4">
                        ...
                        <pre class="bg-gray-100 dark:bg-teal-900 rounded-b-lg p-4 overflow-x-auto"><code class="language-{} text-sm font-mono block whitespace-pre">"#,
                    lang_display,
                    lang_class
                ).unwrap();
            }
            ...
            Event::Start(Tag::Paragraph) => {
                if !in_code_block {
                    html_output.push_str(r#"<p class="mb-4 leading-relaxed">"#);
                }
            }
            ...
            Event::Start(Tag::Heading { level, .. }) => {
                let size_class = match level {
                    pulldown_cmark::HeadingLevel::H1 => "text-2xl font-bold mb-4 mt-6",
                    pulldown_cmark::HeadingLevel::H2 => "text-xl font-semibold mb-3 mt-5",
                    pulldown_cmark::HeadingLevel::H3 => "text-lg font-medium mb-2 mt-4",
                    _ => "text-base font-medium mb-2 mt-3",
                };
            ...
            Event::Start(Tag::Emphasis) => {
                html_output.push_str(r#"<em class="italic">"#);
            }
            ...
            Event::Start(Tag::List(None)) => {
                html_output.push_str(r#"<ul class="list-disc list-inside mb-4 ml-4 space-y-1">"#);
            }
            Event::Start(Tag::List(Some(_))) => {
                html_output
                    .push_str(r#"<ol class="list-decimal list-inside mb-4 ml-4 space-y-1">"#);
            }
            ...
            Event::Start(Tag::BlockQuote(_)) => {
                html_output.push_str(r#"<blockquote class="border-l-4 border-gray-300 dark:border-teal-600 pl-4 py-2 my-4 italic text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-teal-800/50 rounded-r-lg">"#);
            }
            ...
            Event::Start(Tag::Table(_)) => {
                html_output.push_str(r#"<div class="overflow-x-auto my-4"><table class="min-w-full border border-gray-300 dark:border-teal-600">"#);
            }
            Event::End(TagEnd::Table) => {
                html_output.push_str("</table></div>");
            }
            Event::Start(Tag::TableHead) => {
                html_output.push_str(r#"<thead class="bg-gray-100 dark:bg-teal-800">"#);
            }
            ...
            Event::Start(Tag::TableCell) => {
                html_output.push_str(
                    r#"<td class="border border-gray-300 dark:border-teal-600 px-3 py-2">"#,
                );
            }
