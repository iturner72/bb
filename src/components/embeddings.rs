...
#[component]
pub fn EmbeddingsProcessor() -> impl IntoView {
    ...
    let start_embeddings = move || {
        ...
        wasm_bindgen_futures::spawn_local(async move {
            ...
            let url = format!("/api/generate-embeddings?stream_id={}", stream_id);
    ...
    view! {
        <div class="p-4 space-y-4">
            <div class="flex items-center justify-between">
                ...
                >
                    {move || if is_processing() { "Cancel" } else { "Generate Embeddings" }}
                </button>
